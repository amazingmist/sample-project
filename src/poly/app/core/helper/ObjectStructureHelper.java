...
public class ObjectStructureHelper {
    ...
    public static final String[] THONGKETONGHOPDIEM_TABLE_IDENTIFIERS = {"Chuyên đề", "Số học viên", "Cao nhất", "Thấp nhất", "Điểm trung bình"};
    public static final String[] THONGKEDOANHTHU_TABLE_IDENTIFIERS = {"Chuyên đề", "Số khoá", "Số học viên", "Doanh thu", "Học phí cao nhất", "Học phí thấp nhất", "Học phí trung bình"};
